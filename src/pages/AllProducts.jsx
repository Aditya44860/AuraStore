      ...
      try {
        const url =
          selectedFilter === "all"
            ...
            : `${import.meta.env.VITE_API_BASE_URL}/api/products?subcategory=${selectedFilter}&page=${currentPage}&limit=${itemsPerPage}&sortBy=${sortBy}`;
      ...
      <div className="relative z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
          <div className="text-center mb-10 sm:mb-14">
            ...
            <p className="text-gray-500 text-sm sm:text-[15px] font-medium mb-8">
              Complete Collection
            </p>
          ...
          {loading && products.length === 0 ? (
            ...
            <div className="overflow-hidden">
              <div
                className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 transition-all duration-300 ease-[cubic-bezier(0.25,0.46,0.45,0.94)]"
                style={{
                  transform: isSorting
